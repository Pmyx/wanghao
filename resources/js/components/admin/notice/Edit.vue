    ...
    <div>
        ...
        <el-form :model="site" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="所属分类">
                <el-select prop="site_node_id" filterable placeholder="请选择" size="medium" v-model="site.site_node_id">
                    <el-option
            ...
            <el-form-item label="排序" prop="sort">
                <el-input-number v-model="site.sort" @change="handleChange" :min="1" :max="99" label="描述文字">
                </el-input-number>
            </el-form-item>
            <el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            init() {
                ...
                axios.get(`/admin/site/${id}/edit`).then((res) => {
                    //console.log(res);return;
                    this.site = res.data
                    let data =this.site.is_show;
                    this.site.is_show=!!data;           //转换为布尔值
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        axios.put(`/admin/site/${this.site.id}`, this.site).then((res) => {
                            //提示消息
                            this.$notify({
                                title: '成功',
                                message: '编辑成功',
